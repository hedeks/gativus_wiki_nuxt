  ...
  <div class="placeholder-page">
    <div class="placeholder-card">
      <div class="placeholder-icon-wrap">
        <UIcon name="i-heroicons-document-magnifying-glass" class="placeholder-icon" />
      </div>
      <h1 class="placeholder-title">Глоссарий</h1>
      <p class="placeholder-desc">
        Алфавитный список терминов GTOM, GNET, GATE с определениями, категориями и перекрёстными ссылками.
      </p>
...
useSeoMeta({
  ...
  description: 'Полный глоссарий терминов теории GTOM, сети GNET и устройства GATE.',
})
</script>
