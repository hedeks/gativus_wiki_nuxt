...
export default defineEventHandler(async (event) => {
    ...
    return (items || []).map((a) => ({
      id: a.id,
      slug: a.slug,
      title: resolveLocalized(a.title, a.title_ru, a.title_zh, isRu, isZh) || '',
      excerpt: resolveLocalized(a.excerpt, a.excerpt_ru, a.excerpt_zh, isRu, isZh) || '',
      book_id: a.book_id,
      book_slug: a.book_slug || null,
      book_cover_image: a.book_cover_image || null,
